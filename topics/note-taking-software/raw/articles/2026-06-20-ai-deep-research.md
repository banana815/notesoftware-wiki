...
urls:
  ...
  - https://anthemcreation.com/en/artificial-intelligence/ai-plugins-obsidian-2026-comparison/
  - https://bibigpt.co/blog/posts/tana-voice-agent-live-digest-bibigpt
  - https://wiki.heptabase.com/changelog/changelog
  - https://dev.to/jovan_chan_9500711396d4e6/khoj-review-2026-your-self-hosted-ai-second-brain-28mi
  - https://neuronad.com/notion-ai-vs-obsidian/
type: articles
tags: [ai, agent, rag, llm, semantic-search, comparison]
confidence: high
quality_score: 4
credibility: high
---
...
| **Custom Agents** | 2026.2 上线，100万+ 已创建。定时/触发器执行，跨 workspace 共享 |
...
**评价**: Notion 已不是"笔记+AI"，而是"以 AI Agent 为核心的工作流基础设施"。月处理 4500万+ AI 查询，82% Fortune 500 已激活 AI。AI 贡献 ~50% 近期收入增长。
...
| **Live Meeting Digest** | 实时会议转录 + 截图 + AI 子区，三位一体，会议结束即出结构化文档 |
| **AI Command Nodes** | AI 操作作为一等节点，与其他节点同等可引用和查询 |
| **Custom Agents** | 2026.5 上线。自然语言描述即创建（"每天早上8点扫描昨天 #meeting-notes 并朗读摘要"） |
...
| 能力 | 详情 |
|------|------|
| **Smart Connections** | 本地 Embedding + RAG，78万+ 下载量。100% 本地嵌入，零 API Key |
...
**评价**: Obsidian 的 AI 策略是"不内置，但让社区做得最好"。用户可在 $0/mo（本地）到 ~$15/mo（Copilot Plus）之间自由选择。核心优势：无论用哪个 AI 方案，你的数据都是本地 Markdown 文件。

### Heptabase — 最专注学习的 AI Tutor

| 能力 | 详情 |
|------|------|
| **AI Tutor** | 2026.3.31 上线。结构化个性化教学系统。~20+ 次迭代至 v1.98（6月） |
...
| **定价** | Free（100 AI credits/mo）, Pro $8/mo, **Pro+AI $18/mo**（2万 credits） |
